...
<p align="center" text-color='blue'>
  Just download the <a href="https://github.com/Parvat-web-dev/Tkinter-Module/archive/main/TkinterModule.py">TkinterModule.py</a> in the directory where you are creating a py file!
